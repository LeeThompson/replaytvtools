...
#define lpszTitle	"ReplayTV 5000 (Alpha) GuideParser v1.01 (Build 14)"
...
typedef struct tagGuideSnapshotHeader { 
    WORD major;                		// Major Revision (5 for Replay5000s, 3 for Replay 4000/4500s)
...
int main(int argc, char* argv[])
{
   ...
   if (fmodeDebug)
    ...
    if (strGuideHeader.GuideSnapshotHeader.major != 5) 
    {
        ...
        else
        {
            ...
            printf("This version of GuideParser only supports ReplayTV Models 5040, 5080, 5160 and 5320.\n");
        }
